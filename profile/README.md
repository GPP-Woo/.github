...
Ondertussen gaan we verder met ontwikkelen. Samen met de deelnemende gemeenten hebben we op hoofdlijnen (epics) de prioriteiten bepaald. Zie hiervoor [de lijst met epics](https://github.com/orgs/GPP-Woo/projects/1/views/29). Recent (mei 2025) hebben we de "lokale thema's" en "Bewaartermijnen archiefbeheer" opgeleverd. In juni en juli 2025 werken we verder aan het uitbreiden en verbeteren van de API's t.b.v. integraties met zaaksystemen en andere bronsystemen. Ook voeren we enkele verbeteringen door t.b.v. de gebruiksvriendelijkheid voor medewerkers en burgers.
