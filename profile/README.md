...
Met het project ‘Generiek Publicatieplatform Woo (GGP-Woo)’ hebben de samenwerkende gemeenten een generiek publicatieplatform ontwikkeld en gerealiseerd voor de publieke openbaarmaking van documenten en metadata. Deze oplossing bestaat uit een viertal componenten:
